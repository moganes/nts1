...
public class EquipmentContainer {
   /* @Id
    ...
    @Column(name = "equipment_container_sid", unique = true, nullable = false)
    private Long equipment_container_sid;*/

    @PrePersist
    private void prePersist() {
        equipment_container_sid = UUID.randomUUID();
    }

    @Id
    @GeneratedValue
    @Column(name = "equipment_container_sid", unique = true, nullable = false)
    private UUID equipment_container_sid;
