...
/*    @Id
    ...
    @Column(name = "contacts_roc_email")
    @JsonProperty("contacts_roc_email")
    private String contactsRocEmail;

    @Column(name = "contacts_roc_phone")
    @JsonProperty("contacts_roc_phone")
    private String contactsRocPhone;
    ...
    private String remedyTechGroups;
