...
@Table(name = "equipment_module")
public class EquipmentModule {
 /*   @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "equipment_module_sid", unique = true, nullable = false)
    private Long equipment_module_sid;*/

    @PrePersist
    private void prePersist() {
        equipment_module_sid = UUID.randomUUID();
    }

    @Id
    @GeneratedValue
    @Column(name = "equipment_module_sid", unique = true, nullable = false)
    private UUID equipment_module_sid;
