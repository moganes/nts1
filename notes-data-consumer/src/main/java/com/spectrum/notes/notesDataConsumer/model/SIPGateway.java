...
@NoArgsConstructor
@Entity
@Table(name = "sip_gateway")
public class SIPGateway {
/*    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "sip_gateway_sid", unique = true, nullable = false)
    private Long sipGatewaySid;*/

    @PrePersist
    private void prePersist() {
        sipGatewaySid = UUID.randomUUID();
    }

    @Id
    @GeneratedValue
    @Column(name = "sip_gateway_sid", unique = true, nullable = false)
    private UUID sipGatewaySid;
